            ...
            <div class="singular-content-wrap">
                <?php if ($chkId): ?>
                    <?php
                        ...
                        $titleQuery = urlencode($final['artists_name'].' - '.$final['title']);
                        $curl = curl_init();
                        ...
                        foreach ($response->data as $key => $q) {
                            $chkSongTitle = strpos($q->name, 'Medley Of Hits');
                                            ...
                                            <p>
                                                ...
                                                <span class="album-info-value">
                                                    <?php if (isset($data->external_metadata->deezer[0]->link)): ?>
                                                        <a target="_blank" href="<?=$data->external_metadata->deezer[0]->link?>">Deezer</a>
                                                    <?php endif ?>
                                                    <?php if (isset($data->external_metadata->spotify[0]->link)): ?>
                                                        <a target="_blank" href="<?=$data->external_metadata->spotify[0]->link?>">Spotify</a>
                                                    <?php endif ?>
                                                    <?php if (isset($data->external_metadata->youtube->vid)): ?>
                                                        <a target="_blank" href="https://www.youtube.com/watch?v=<?=$data->external_metadata->youtube->vid?>">Youtube</a>
                                                    <?php endif ?>
                                                </span>
                                            </p>
